...
```
### Многомерные массивы
Создаются через функцию newarray из модуля std (Импортировать не надо. Модуль всегда импортирован.)
...
```
### вызов функции
Чтобы вы можете использовать возвращающую функцию везде, как переменную. Пример:
```
print sum(10, 15)
```
